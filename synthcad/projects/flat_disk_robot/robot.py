...
ROBOT_AXLE_Y = -18.0
ROBOT_WHEEL_GROUND_PROTRUSION = 6.0
...
WHEEL_SLOT_CUTOUT_Z_MIN = ROBOT_AXLE_Z - ROBOT_WHEEL_RADIUS - 0.5
WHEEL_SLOT_CUTOUT_Z_MAX = ROBOT_CHASSIS_THICKNESS + PERIMETER_WALL_HEIGHT + 0.5
WHEEL_SLOT_CUTOUT_HEIGHT = WHEEL_SLOT_CUTOUT_Z_MAX - WHEEL_SLOT_CUTOUT_Z_MIN
WHEEL_SLOT_CUTOUT_CENTER_Z = WHEEL_SLOT_CUTOUT_Z_MIN + WHEEL_SLOT_CUTOUT_HEIGHT / 2
...
LID_WHEEL_WELL_CUTOUT_Z_MAX = max(
    LID_TOP_SURFACE_Z,
    ROBOT_AXLE_Z + ROBOT_WHEEL_RADIUS,
) + 0.2
        ...
        for side in [-1, 1]:
            with Locations(
                (
                    ...
                    ROBOT_AXLE_Y,
                    WHEEL_SLOT_CUTOUT_CENTER_Z,
                )
            ):
                Box(
                    WHEEL_SLOT_SIZE[0],
                    WHEEL_SLOT_SIZE[1],
                    WHEEL_SLOT_CUTOUT_HEIGHT,
                    mode=Mode.SUBTRACT,
                )
